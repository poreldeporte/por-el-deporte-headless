...
const COLLAGE: {
  ...
  },
  {
    ...
    dx: 70,
    dy: -34,
    img: 'https://cdn.shopify.com/s/files/1/0548/8492/5487/files/ped-2025-family-matchday.jpg?v=1785797955&width=900',
    alt: 'A Por El Deporte family on match day',
    backer: '#cfe3f2',
    shadow: 'translate(10px, 12px)',
  },
  {
    ...
    dx: 0,
    dy: 80,
    img: 'https://cdn.shopify.com/s/files/1/0548/8492/5487/files/ped-2025-squad-goal-kids.jpg?v=1785797955&width=1400',
    alt: 'The Por El Deporte squad in the goal with the youngest supporters',
    backer: '#e7ded0',
